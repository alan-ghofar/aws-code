...
def functionGet(con, event):
    ...
    sql = "SELECT id, description, notes, day FROM `sl_01_m_routes` WHERE delete_mark = 0 AND active = 1"
...
def functionPost(con, event):
    ...
    try:
        sqlInsert = """
        INSERT INTO `sl_01_m_routes`
            (description, notes, day, active, create_by, create_date, delete_mark)
        VALUES
            (%s, %s, %s, %s, %s, %s, 0)
        """
    
        cur.execute(sqlInsert, (req['description'], req['notes'], req['day'], 
...
def functionPut(con, event):
    ...
    try:
        ...
        cur.execute(sqlUpdate, (req['description'], req['notes'], req['day'], req['active'], vToken['id_user'], datetime.datetime.now(tz_JKT), id))
