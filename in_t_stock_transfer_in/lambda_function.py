...
tableName = 'in_01_t_location_transfer_in'
...
def functionPost(con, event):
    ...
    try:
        ...
        req['status_transfer'], str(req['doc_ref']), req['no_ref'], req['trans_date'], str(req['memo']), str(req['status_code']), str(vToken['id_user']), stritm, trans_no))
