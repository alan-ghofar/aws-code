...
def functionGet(con, event):
    ...
    SELECT
        ...
        ul.kode_perusahaan,
        p.nama_perusahaan,
        ul.default_perusahaan
    FROM
        `sc_02_user_perusahaan` ul
...
def functionPost(con, event):
    ...
    sqlInsert = "INSERT INTO `sc_02_user_perusahaan` ( id_user, kode_perusahaan, default_perusahaan, create_by, create_date, delete_mark ) VALUES (%s, %s, %s, %s, %s, 0)"
    cur.execute(sqlInsert, (req['id_user'], req['kode_perusahaan'], req['default_perusahaan'], vToken['id_user'], datetime.datetime.today()))
    id = con.insert_id()
...
def functionPut(con, event):
    ...
    params = event['queryStringParameters']
    id = params['id']
    sqlUpdate = "UPDATE `sc_02_user_perusahaan` SET `id_user` = %s, `kode_perusahaan` = %s, `default_perusahaan` = %s, `update_by` = %s, `update_date` = %s WHERE id=%s"
    cur.execute(sqlUpdate, (req['id_user'], req['kode_perusahaan'], req['default_perusahaan'],
                vToken['id_user'], datetime.datetime.today(), id))
...
def functionDelete(con, event):
    ...
    params = event['queryStringParameters']
    id = params['id']
    sqlUpdate = "UPDATE `sc_02_user_perusahaan` SET delete_by=%s, delete_date=%s, delete_mark=%s WHERE id=%s"
