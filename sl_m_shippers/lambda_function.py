...
def functionGet(con, event):
    ...
    sql = "SELECT shipper_id, shipper_name, contact_name, phone, phone2, address, active FROM `sl_01_m_shippers` WHERE delete_mark = 0 AND active = 1"
    
    if params is not None:
        if params.get('id'):
            sql += " AND shipper_id = " + params.get('id')
...
def functionPost(con, event):
    ...
    try:
        sqlInsert = """
        INSERT INTO `sl_01_m_shippers`
            (shipper_name, contact_name, phone, phone2, address, active, create_by, create_date, delete_mark)
        VALUES
            (%s, %s, %s, %s, %s, %s, %s, %s, 0)
        """
        
        cur.execute(sqlInsert, (req['shipper_name'], req['contact_name'], req['phone'], req['phone2'], req['address'], 
...
def functionPut(con, event):
    ...
    try:
        ...
        cur.execute(sqlUpdate, (req['shipper_name'], req['contact_name'], req['phone'], req['phone2'], req['address'], 
